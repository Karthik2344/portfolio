      ...
      <div className="education_container container">
        <div className="education_tabs">
          <div
            ...
            className={
              toggleState === 1
                ? "education_button education_active button_flex"
                : "education_button button_flex"
            }
          >
            <i className="uil uil-graduation-cap education_icon"></i> Education
          </div>
          ...
          >
            <i className="uil uil-briefcase-alt education_icon"></i> Experience
          </div>
        </div>
        <div className="education_sections">
          ...
          >
            <div className="education_data">
              <div>
                ...
                <span className="education_subtitle">CGPA - 8.28</span>
            ...
            <div className="education_data">
              ...
              <div>
                ...
                <span className="education_subtitle">Percentage - 98</span>
                <div className="education_calendar">
            ...
            <div className="education_data">
              ...
              <div>
                <h3 className="education_title">St.Mary's E.M school</h3>
                <span className="education_subtitle">Upto 6th class</span>
                <div className="education_calendar">
          ...
          >
            <div className="education_data">
              <div>
                <h3 className="education_title">Machine Learning</h3>
