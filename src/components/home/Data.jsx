    ...
    <>
      <div className="home_data">
        <div className="text_box">
          <h3 className="home_title start">I'm</h3>
          ...
          <h3 className="home_subtitle">
            Full Stack Web Developer / Competitive Coder / <br />{" "}
          </h3>
        </div>
        <p className="home_description">
          I'm a creative Web Developer focused on crafting user-friendly,
          impactful projects. I’m passionate about building excellent software
          that enhances the user experience and brings real value to those
          around me. I thrive on innovation and constantly seek new ways to
          solve problems and create seamless digital experiences.
        </p>
