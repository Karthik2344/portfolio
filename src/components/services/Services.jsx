          ...
          >
            <div className="services_modal-content">
              ...
              <p className="services_modal-description">
                "I utilize a variety of project experiences to develop
                innovative web solutions, ensuring high-quality deliverables
                that exceed company expectations."
              </p>
              <ul className="services_modal-services grid">
                <li className="services_modal-service">
                  <i className="uil uil-check-circle services_modal-icon"></i>
                  <p className="services_modal-info">
                    Proficient in crafting engaging and intuitive User
                    Interfaces.
                  </p>
                </li>
                <li className="services_modal-service">
                ...
                <li className="services_modal-service">
                  <i className="uil uil-check-circle services_modal-icon"></i>
                  <p className="services_modal-info">
                    Experienced in crafting tailored Full Stack Websites to
                    company needs.
                  </p>
                </li>
              </ul>
        ...
        <div className="services_content">
          ...
          >
            <div className="services_modal-content">
              ...
              <p className="services_modal-description">
                "Through a rich variety of project experiences, I consistently
                deliver high-quality, data-driven solutions that drive business
                success."
              </p>
              <ul className="services_modal-services grid">
                <li className="services_modal-service">
                ...
                <li className="services_modal-service">
                  <i className="uil uil-check-circle services_modal-icon"></i>
                  <p className="services_modal-info">
                    Skilled in deploying machine learning models for business
                    solutions.
                  </p>
                </li>
              </ul>
        ...
        <div className="services_content">
          ...
          >
            <div className="services_modal-content">
              ...
              <p className="services_modal-description">
                "I deliver high-quality solutions by leveraging a diverse range
                of project experiences and skills."
              </p>
              <ul className="services_modal-services grid">
                <li className="services_modal-service">
                  <i className="uil uil-check-circle services_modal-icon"></i>
                ...
                <li className="services_modal-service">
                  <i className="uil uil-check-circle services_modal-icon"></i>
                  <p className="services_modal-info">
                    Proficient in developing efficient code solutions for
