...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm("service_faoh6zi", "template_xb2mf1l", form.current, {
      publicKey: "zoXYJApsp97EbmV76",
    });
    e.target.reset();
  };
          ...
          <div className="contact_info">
            <div className="contact_card">
              ...
              <span className="contact_card-data">
                karthikkodamanchili2344@gmail.com
              </span>
            ...
            <div className="contact_card">
              ...
              <span className="contact_card-data">7032362829</span>
            ...
            <div className="contact_card">
              ...
              <span className="contact_card-data">Karthik Kodamanchili</span>
